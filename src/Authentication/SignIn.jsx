...
import { auth, signInWithGooglePopup, signInWithEmail, signUpWithEmail } from "../firebase";
...
const SignIn = () => {
  ...
  //     setSuccess("successfuly inserted");
  //   } catch (error) {
              ...
              <form onSubmit={handleEmailSignIn}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-dark dark:focus:border-primary"
                    />
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/signup" className="text-primary hover:text-indigo-800">
                      Sign Up
                    </Link>
                  </p>
                </div>
